/**
 * Environment variable overrides for Understudy configuration.
 * Extracted from config.ts to keep ConfigManager thin.
 */
...
// ---------------------------------------------------------------------------
// Update helpers — apply partial patches to config sub-sections
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Env override application — per section
// ---------------------------------------------------------------------------
...
export function applyEnvOverrides(config: UnderstudyConfig): UnderstudyConfig {
	const result = { ...config };
...
export function loadDotenvFiles(resolvedConfigPath: string): void {
...
// ---------------------------------------------------------------------------
// Arg list parsing (for ACP_ARGS env var)
// ---------------------------------------------------------------------------

export function parseEnvArgList(raw: string): string[] {
...
// ---------------------------------------------------------------------------
// Deep merge utility (also used by ConfigManager)
// ---------------------------------------------------------------------------
