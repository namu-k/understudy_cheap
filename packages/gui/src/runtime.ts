...
} from "./runtime/platform-detection.js";
import {
	createGroundingResolution,
	createScreenshotObservation,
	defaultGroundingModeForAction,
	describeGuiTarget,
	summarizeGroundingTelemetry,
} from "./runtime/grounding-adapter.js";
import {
	...
	performType,
	resolveCaptureMode,
	resolveClickActionIntent,
	resolveMacOsCaptureContext,
	resolveScrollPlan,
} from "./runtime/actions-macos.js";
import {
	captureWin32Screenshot,
	performWin32Click,
	performWin32Drag,
	performWin32Hotkey,
	performWin32Move,
	performWin32Scroll,
	performWin32Type,
	resolveCaptureContextWin32,
} from "./runtime/actions-win32.js";

export { GUI_UNSUPPORTED_MESSAGE, GuiRuntimeError, isGuiPlatformSupported } from "./runtime/platform-detection.js";
...
async function resolveCaptureContext(
	...
	return resolveMacOsCaptureContext(appName, options);
}
